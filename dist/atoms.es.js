...
import { F as u, R, I as x, T as v, L as q } from "./index-CuJ3T9JN.js";
...
se.Tab = (e) => null;
const ae = ({ children: e, size: n, color: i, weight: l, className: o, ...r }) => /* @__PURE__ */ t(
  u,
  {
...
function be(e, n) {
  const { width: i, height: l } = fe(), o = we();
  y(() => {
    const r = e.current;
    r != null && (r[T] = n);
  }, [e, n]), y(() => {
