...
import { c as colors, i as i18nInstance } from "./colors-gpRgsXSS.js";
import { F as Flex, R as Render, T as Text, B as Breadcrumb, b as Link, I as Icon, c as Tooltip$1, L as Loading, D as Dropdown, a as InfiniteLoader, d as Image, u as useNavigate, e as useSearchParams } from "./index-TDH6Fv86.js";
import React__default, { useState, useEffect, Children, useMemo, forwardRef, useCallback, useRef, useLayoutEffect, createContext, memo, useReducer, useContext, isValidElement } from "react";
import require$$2, { unstable_batchedUpdates, createPortal } from "react-dom";
import { useTranslation } from "react-i18next";
import { twMerge } from "tailwind-merge";
import { Checkbox as Checkbox$1, Collapse as Collapse$1, Popover as Popover$1, Radio as Radio$1, Input as Input$1, Tooltip as Tooltip$2, Divider, Select as Select$1, ConfigProvider, TreeSelect, TimePicker, Tabs, Upload as Upload$1 } from "antd";
...
const BorderedTitle = ({
  ...
  return /* @__PURE__ */ jsxs(Flex, { className: "w-full", align: "center", gap: 8, children: [
    /* @__PURE__ */ jsx(Render, { when: align !== "start", children: /* @__PURE__ */ jsx("hr", { className: "border-light-7 flex  h-[1px] flex-1 border" }) }),
    ...
    /* @__PURE__ */ jsx(Render, { when: align !== "end", children: /* @__PURE__ */ jsx("hr", { className: "border-light-7 flex h-[1px] flex-1 border" }) })
  ] });
};
...
function requireMain() {
  ...
  (function(module, exports$1) {
    !(function(e, t) {
      module.exports = t(requireMomentJalaali(), React__default, require$$2);
    })(main, (function(e, t, a) {
      return (function() {
    ...
    Flex,
    {
      ...
      children: [
        label && /* @__PURE__ */ jsxs("div", { className: "flex h-[24px] items-center gap-1", children: [
          typeof label === "string" ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
            Text,
            {
              lang,
                ...
                "div",
                {
                  ...
                  children: suffix && /* @__PURE__ */ jsx("div", { className: ` flex h-full items-center justify-center`, children: suffix }) || error?.message && helperText && !suffix && !disabled && /* @__PURE__ */ jsx(
                    "div",
                    {
                      id: "my-anchor-element",
                      className: ` flex h-full cursor-pointer items-center justify-center`,
                      children: /* @__PURE__ */ jsx(Tooltip$2, { color: colors.negative, title: error.message, arrow: true, children: /* @__PURE__ */ jsx(Icon, { name: "alert-line", color: colors.negative }) })
                    }
                  )
                }
              )
...
const InputNumber = forwardRef((props, ref2) => {
  ...
  return /* @__PURE__ */ jsxs(
    Flex,
    {
      ...
      children: [
        label && /* @__PURE__ */ jsxs("div", { className: "flex h-[24px] items-center gap-1", children: [
          typeof label === "string" ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(Text, { size: inputSize === "large" ? 14 : 12, color: colors.primary, weight: "normal", children: label }) }) : label,
          /* @__PURE__ */ jsx(Render, { when: required, children: /* @__PURE__ */ jsx(Icon, { name: "Asterisk", size: 6, color: colors.negative, className: "mb-2" }) })
        ] }),
        /* @__PURE__ */ jsx(
          Input$1,
...
const useNotification = () => {
  ...
  const successfullyAdded = () => {
    success({
      message: /* @__PURE__ */ jsx(Text, { showTooltipOnTruncate: false, weight: "medium", size: 16, color: colors.white_ff, children: t("common.message.successfullyAdded") })
    });
  };
  const successfullyEdited = () => {
    success({
      message: /* @__PURE__ */ jsx(Text, { showTooltipOnTruncate: false, weight: "medium", size: 16, color: colors.white_ff, children: t("common.message.successfullyEdited") })
    });
  };
  const successfullyDeleted = () => {
    success({
      message: /* @__PURE__ */ jsx(Text, { showTooltipOnTruncate: false, weight: "medium", size: 16, color: colors.white_ff, children: t("common.message.successfullyDeleted") })
    });
  };
  const copied = () => {
    success({
      message: /* @__PURE__ */ jsx(Text, { showTooltipOnTruncate: false, weight: "medium", size: 16, color: colors.white_ff, children: t("common.message.copied") })
    });
  };
  return {
    success,
...
const SelectNotFound = ({ error, noContentFoundMessage }) => {
  ...
  return /* @__PURE__ */ jsxs(Flex, { justify: "center", align: "center", gap: 4, className: "h-[100px]", children: [
    ...
    /* @__PURE__ */ jsx(Text, { size: 14, color: error?.message ? colors.negative : colors.primary_light_2, children: noContentFoundMessage ? noContentFoundMessage : error?.message ? t("common.literal.listError") : t("common.message.noResultFound") })
  ] });
};
          ...
          /* @__PURE__ */ jsx(ConfigProvider, { theme: CustomizedAntSelectConfig, children: /* @__PURE__ */ jsxs(Flex, { align: "center", children: [
            ...
            /* @__PURE__ */ jsx(
              Select$1,
              {
                ...
                bordered: false,
                maxTagCount: 0,
                maxTagPlaceholder: /* @__PURE__ */ jsx(Text, { children: t("common.message.itemsSelectedWithCount", { count: _value.length }) }),
                ...
                children: options?.map((item, index) => {
                  ...
                  return /* @__PURE__ */ jsx(
                    Option$1,
                    {
                      label: labelExtractor(item),
                      value: valueExtractor(item),
                      valueRender: renderSelectedItem ? renderSelectedItem(item) : /* @__PURE__ */ jsx(Text, { color: colors.primary_dark_1, lang: lang || i18nInstance.language, children: labelExtractor(item) }),
                      disabled: disableExtractor(item),
...
const useIsomorphicLayoutEffect = canUseDOM$1 ? useLayoutEffect : useEffect;
...
const NotFoundAddItem = ({ onAddNewItem }) => {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx(Flex, { justify: "start", align: "center", gap: 4, className: "p-5", children: /* @__PURE__ */ jsx(Text, { className: "bg-light-2 w-full cursor-pointer p-2", size: 14, onClick: onAddNewItem, children: t("common.literal.addInputTag") }) });
};
...
const InputTimePicker = ({ className, error, ...rest }) => {
  return /* @__PURE__ */ jsx(ConfigProvider, { theme: timePickerTheme, children: /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      TimePicker,
      {
        size: "large",
...
export {
  ...
  DndContext as D,
  SelectNotFound as E,
  SelectPlaceholder as F,
  SelectSuffix as G,
  Tag as H,
  InputErrorMessage as I,
  TagInput as J,
  InputTimePicker as K,
  Box as L,
  MouseSensor as M,
  NavigationTabs as N,
  VerticalTabs as O,
  ...
  ActionHeader as p,
  Button as q,
  buttonDefaultClasses as r,
  fontSizePicker as s,
  paddingPicker as t,
  useSensors as u,
  verticalListSortingStrategy as v,
  useNotification as w,
  Select as x,
  SelectClearIcon as y,
  SelectLabel as z
};
