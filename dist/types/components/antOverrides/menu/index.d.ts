...
declare const Menu: {
    ...
    ItemGroup: import('react').ForwardRefExoticComponent<Pick<import('antd/es/menu').MenuItemGroupProps, "className" | "style" | "children" | "title" | "eventKey" | "warnKey"> & import('react').RefAttributes<HTMLLIElement>>;
};
export { Menu };
