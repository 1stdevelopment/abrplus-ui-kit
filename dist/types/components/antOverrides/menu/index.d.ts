...
declare const Menu: {
    ...
    ItemGroup: import('react').ForwardRefExoticComponent<Pick<import('antd/es/menu').MenuItemGroupProps, "children" | "style" | "title" | "className" | "eventKey" | "warnKey"> & import('react').RefAttributes<HTMLLIElement>>;
};
export { Menu };
