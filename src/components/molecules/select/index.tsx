...
import { DefaultSelectOption, SelectInfinite, SelectProps, SelectRawValue, PlusTreeSelectProps } from './types';

const Select = batch({ Single: SingleSelect, Multiple: MultipleSelect, Tree: PlusTreeSelect });

export { Select };
export type { DefaultSelectOption, SelectInfinite, SelectProps, SelectRawValue, PlusTreeSelectProps };
